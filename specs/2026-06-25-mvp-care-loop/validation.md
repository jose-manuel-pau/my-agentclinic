...
- Vitest covers appointment status transition rules for requested, confirmed, rescheduled, cancelled, and completed where implemented.
...
- Invalid form submissions show useful validation feedback without losing the whole page state.
...
- Start the app locally with documented environment variables and a migrated PostgreSQL database.
